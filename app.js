...
async function recreateDB(){ 
  ...
  let instance1 = new Costume({costume_type:"Ghost",  size:'large', cost:126.4}); 
  let instance2 = new Costume({costume_type:"Happy days",  size:'Medium', cost:139.4}); 
  let instance3 = new Costume({costume_type:"Life is beautiful",  size:'small', cost:146.6}); 
